...
{
	uint32_t pixelData = colorBuffer[y * width + x];
	Color pixelColor;
	pixelColor.r = pixelData && redMask;
	pixelColor.g = pixelData && greenMask;
	pixelColor.b = pixelData && blueMask;
	pixelColor.a = pixelData && alphaMask;
